        ...
        for field, ty in ty_hints.items():
            ...
            if "_" in cls.__name__ and field == "value" and field not in data:
                ...
                if ty in cls._PRIMITIVE_TYPES:
                    ...
                    cls_dict["value"] = [cls._instantiate_typed_field(el, get_args(ty)[0]) for el in data]
                else:
            ...
            if ty in cls._PRIMITIVE_TYPES:
                ...
                cls_dict[original_field] = [cls._instantiate_typed_field(el, get_args(ty)[0]) for el in field_data]
            else:
                field_data = data[field]
